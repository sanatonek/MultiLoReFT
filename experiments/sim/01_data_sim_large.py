...
input_dims_0 = [50, 100, 500]
input_dims_1 = [50, 100, 500]
data_dims_0 = [50, 100, 500, 1000, 10000]
data_dims_1 = [50, 100, 500, 1000, 10000]
shared_dim_options = [0.5]
n_classes = 2
class_location_options = ['shared']
            ...
            for data_dim0 in data_dims_0:
                ...
                for data_dim1 in data_dims_1:
                    ...
                    for shared_dim in shared_dim_options:
                        # shared_dim is the fraction of the min data_dim that is shared
                        shared_dim = int(shared_dim * min(data_dim0, data_dim1))
