...
if __name__ == "__main__":
    ...
    file_name = f"sweep_v11_methodParams_reduceJointLR_ES" # here I changed part of the training objective to use the forward pass again
